...
enum class eACE : uint64_t {
    ...
    ACE_User2_Set_CommonName = ACE_User1_Set_CommonName + 1,
    ACE_User3_Set_CommonName = ACE_User1_Set_CommonName + 2,
    ACE_User4_Set_CommonName = ACE_User1_Set_CommonName + 3,
    ACE_User5_Set_CommonName = ACE_User1_Set_CommonName + 4,
    ACE_User6_Set_CommonName = ACE_User1_Set_CommonName + 5,
    ACE_User7_Set_CommonName = ACE_User1_Set_CommonName + 6,
    ACE_User8_Set_CommonName = ACE_User1_Set_CommonName + 7,
    ACE_User9_Set_CommonName = ACE_User1_Set_CommonName + 8,
    ACE_User10_Set_CommonName = ACE_User1_Set_CommonName + 9,
    ACE_User11_Set_CommonName = ACE_User1_Set_CommonName + 10,
    ACE_User12_Set_CommonName = ACE_User1_Set_CommonName + 11,
